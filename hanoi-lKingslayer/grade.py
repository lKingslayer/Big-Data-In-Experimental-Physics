...
for file in sorted(files):
    ...
    try:
        ...
        pass
    p = subprocess.Popen([sys.executable, 'hanoi.py'], stdin=open(file_in, 'r'), stdout=open(file_out,'w'), stderr=subprocess.PIPE)
    ...
    if file_lines(file_ans) == file_lines(file_out):
        ...
        print('Data %d: not the expcted sequence' % num)
